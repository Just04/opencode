export const dict = {
  ...
  "desktop.updater.none.message": "Ya estás usando la versión más reciente de TECHART",
  ...
  "desktop.updater.downloaded.prompt":
    "Se ha descargado la versión {{version}} de TECHART. ¿Quieres instalarla y reiniciar?",
