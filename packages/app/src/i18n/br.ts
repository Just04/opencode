export const dict = {
  ...
  "dialog.provider.TECHART.note": "Modelos selecionados incluindo Claude, GPT, Gemini e mais",
  "dialog.provider.TECHART.tagline": "Modelos otimizados e confiáveis",
  "dialog.provider.TECHARTGo.tagline": "Assinatura de baixo custo para todos",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo TECHART",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no TECHART.",
  ...
  "provider.connect.TECHARTZen.line1":
    "TECHART Zen oferece acesso a um conjunto selecionado de modelos confiáveis otimizados para agentes de código.",
  "provider.connect.TECHARTZen.line2":
    "Com uma única chave de API você terá acesso a modelos como Claude, GPT, Gemini, GLM e mais.",
  "provider.connect.TECHARTZen.visit.prefix": "Visite ",
  "provider.connect.TECHARTZen.visit.link": "TECHART.ai/zen",
  "provider.connect.TECHARTZen.visit.suffix": " para obter sua chave de API.",
  "provider.connect.oauth.code.visit.prefix": "Visite ",
  "provider.connect.oauth.code.visit.link": "este link",
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no TECHART.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no TECHART.",
  ...
  "dialog.plugins.empty": "Plugins configurados em TECHART.json",
  ...
  "dialog.server.description": "Trocar para qual servidor TECHART este aplicativo se conecta.",
  ...
  "toast.update.description": "Uma nova versão do TECHART ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do TECHART",
  ...
  "error.chain.checkConfig": "Verifique os nomes de provedor/modelo na sua configuração (TECHART.json)",
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: TECHART ainda não suporta autenticação MCP.',
  ...
  "sidebar.gettingStarted.line1": "TECHART inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.desktop.wsl.description": "Executar o servidor TECHART dentro do WSL no Windows.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do TECHART",
  "settings.general.row.appearance.title": "Aparência",
  "settings.general.row.appearance.description": "Personalize como o TECHART aparece no seu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de cores",
  "settings.general.row.colorScheme.description": "Escolha se o TECHART segue o tema do sistema, claro ou escuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o TECHART é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o TECHART iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do TECHART.",
