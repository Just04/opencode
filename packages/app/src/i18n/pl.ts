export const dict = {
  ...
  "dialog.provider.TECHART.note": "Wyselekcjonowane modele, w tym Claude, GPT, Gemini i inne",
  "dialog.provider.TECHART.tagline": "Niezawodne, zoptymalizowane modele",
  "dialog.provider.TECHARTGo.tagline": "Tania subskrypcja dla każdego",
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez TECHART",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w TECHART.",
  ...
  "provider.connect.TECHARTZen.line1":
    "TECHART Zen daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów kodujących.",
  ...
  "provider.connect.TECHARTZen.visit.prefix": "Odwiedź ",
  "provider.connect.TECHARTZen.visit.link": "TECHART.ai/zen",
  "provider.connect.TECHARTZen.visit.suffix": ", aby odebrać swój klucz API.",
  "provider.connect.oauth.code.visit.prefix": "Odwiedź ",
  "provider.connect.oauth.code.visit.link": "ten link",
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w TECHART.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w TECHART.",
  ...
  "dialog.plugins.empty": "Wtyczki skonfigurowane w TECHART.json",
  ...
  "dialog.server.description": "Przełącz serwer TECHART, z którym łączy się ta aplikacja.",
  ...
  "toast.update.description": "Nowa wersja TECHART ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu TECHART",
  ...
  "error.chain.checkConfig": "Sprawdź swoją konfigurację (TECHART.json) nazwy dostawców/modeli",
  ...
  "sidebar.gettingStarted.line1": "TECHART zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla TECHART",
  "settings.general.row.appearance.title": "Wygląd",
  "settings.general.row.appearance.description": "Dostosuj wygląd TECHART na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy TECHART ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw TECHART.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania TECHART",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji TECHART.",
