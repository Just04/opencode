export const dict = {
  ...
  "dialog.provider.TECHART.note": "Kurirani modeli uključujući Claude, GPT, Gemini i druge",
  "dialog.provider.TECHART.tagline": "Pouzdani optimizovani modeli",
  "dialog.provider.TECHARTGo.tagline": "Povoljna pretplata za sve",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje TECHART",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u TECHART-u.",
  ...
  "provider.connect.TECHARTZen.line1":
    "TECHART Zen ti daje pristup kuriranom skupu pouzdanih, optimizovanih modela za coding agente.",
  "provider.connect.TECHARTZen.line2":
    "Sa jednim API ključem dobijaš pristup modelima kao što su Claude, GPT, Gemini, GLM i drugi.",
  "provider.connect.TECHARTZen.visit.prefix": "Posjeti ",
  "provider.connect.TECHARTZen.visit.link": "TECHART.ai/zen",
  "provider.connect.TECHARTZen.visit.suffix": " da preuzmeš svoj API ključ.",
  "provider.connect.oauth.code.visit.prefix": "Posjeti ",
  "provider.connect.oauth.code.visit.link": "ovaj link",
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u TECHART-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u TECHART-u.",
  ...
  "dialog.plugins.empty": "Plugini su konfigurisani u TECHART.json",
  ...
  "dialog.server.description": "Promijeni na koji se TECHART server ova aplikacija povezuje.",
  ...
  "toast.update.description": "Nova verzija TECHART-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku TECHART timu",
  ...
  "error.chain.checkConfig": "Provjeri konfiguraciju (TECHART.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: TECHART još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "TECHART uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni TECHART server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u TECHART-u",
  "settings.general.row.appearance.title": "Izgled",
  "settings.general.row.appearance.description": "Prilagodi kako TECHART izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li TECHART prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu TECHART-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se TECHART pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju TECHART-a.",
