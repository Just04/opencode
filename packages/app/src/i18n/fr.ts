export const dict = {
  ...
  "dialog.provider.TECHART.note": "Modèles sélectionnés incluant Claude, GPT, Gemini et plus",
  "dialog.provider.TECHART.tagline": "Modèles optimisés et fiables",
  "dialog.provider.TECHARTGo.tagline": "Abonnement abordable pour tous",
  ...
  "dialog.model.unpaid.freeModels.title": "Modèles gratuits fournis par TECHART",
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans TECHART.",
  ...
  "provider.connect.TECHARTZen.line1":
    "TECHART Zen vous donne accès à un ensemble sélectionné de modèles fiables et optimisés pour les agents de codage.",
  "provider.connect.TECHARTZen.line2":
    "Avec une seule clé API, vous aurez accès à des modèles tels que Claude, GPT, Gemini, GLM et plus encore.",
  "provider.connect.TECHARTZen.visit.prefix": "Visitez ",
  "provider.connect.TECHARTZen.visit.link": "TECHART.ai/zen",
  "provider.connect.TECHARTZen.visit.suffix": " pour récupérer votre clé API.",
  "provider.connect.oauth.code.visit.prefix": "Visitez ",
  "provider.connect.oauth.code.visit.link": "ce lien",
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans TECHART.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans TECHART.",
  ...
  "dialog.plugins.empty": "Plugins configurés dans TECHART.json",
  ...
  "dialog.server.description": "Changez le serveur TECHART auquel cette application se connecte.",
  ...
  "toast.update.description":
    "Une nouvelle version d'TECHART ({{version}}) est maintenant disponible pour installation.",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe TECHART",
  ...
  "error.chain.checkConfig": "Vérifiez votre configuration (TECHART.json) pour les noms de fournisseur/modèle",
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'TECHART ne supporte pas encore l'authentification MCP.",
  ...
  "sidebar.gettingStarted.line1":
    "TECHART inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
  ...
  "app.name.desktop": "TECHART Desktop",
  ...
  "settings.desktop.wsl.description": "Exécuter le serveur TECHART dans WSL sur Windows.",
  ...
  "settings.general.row.language.description": "Changer la langue d'affichage pour TECHART",
  "settings.general.row.appearance.title": "Apparence",
  "settings.general.row.appearance.description": "Personnaliser l'apparence d'TECHART sur votre appareil",
  "settings.general.row.colorScheme.title": "Schéma de couleurs",
  "settings.general.row.colorScheme.description": "Choisissez si TECHART suit le thème système, clair ou sombre",
  "settings.general.row.theme.title": "Thème",
  "settings.general.row.theme.description": "Personnaliser le thème d'TECHART.",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement d'TECHART",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version d'TECHART.",
