...
export const dict = {
  ...
  "dialog.provider.TECHART.note": "Claude, GPT, Gemini ve daha fazlasını içeren seçilmiş modeller",
  "dialog.provider.TECHART.tagline": "Güvenilir optimize edilmiş modeller",
  "dialog.provider.TECHARTGo.tagline": "Herkes için düşük maliyetli abonelik",
  ...
  "dialog.model.unpaid.freeModels.title": "TECHART tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve TECHART'da {{provider}} modellerini kullanmak için {{provider}} API anahtarınızı girin.",
  ...
  "provider.connect.TECHARTZen.line1":
    "TECHART Zen, kodlama ajanları için seçilmiş güvenilir optimize edilmiş modellere erişim sağlar.",
  ...
  "provider.connect.TECHARTZen.visit.prefix": "",
  "provider.connect.TECHARTZen.visit.link": "TECHART.ai/zen",
  "provider.connect.TECHARTZen.visit.suffix": " adresini ziyaret ederek API anahtarınızı alın.",
  "provider.connect.oauth.code.visit.prefix":
    "Hesabınızı bağlamak ve TECHART'da {{provider}} modellerini kullanmak için ",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak TECHART'da {{provider}} modellerini kullanın.",
  ...
  "dialog.plugins.empty": "Eklentiler TECHART.json içinde yapılandırılır",
  ...
  "dialog.server.description": "Bu uygulamanın hangi TECHART sunucusuna bağlanacağını değiştirin.",
  ...
  "toast.update.description": "TECHART'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı TECHART ekibine bildirin",
  ...
  "error.chain.checkConfig": "Yapılandırma dosyanızı (TECHART.json) sağlayıcı/model adlarını kontrol edin",
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" başarısız oldu. Not: TECHART henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "sidebar.gettingStarted.line1": "TECHART ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "app.name.desktop": "TECHART Masaüstü",
  ...
  "settings.desktop.wsl.description": "TECHART sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.language.description": "TECHART'un görünüm dilini değiştirin",
  "settings.general.row.appearance.title": "Görünüm",
  "settings.general.row.appearance.description": "TECHART'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description":
    "TECHART'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "TECHART'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "TECHART başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "TECHART'un en son sürümünü kullanıyorsunuz.",
