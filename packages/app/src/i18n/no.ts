...
export const dict = {
  ...
  "dialog.provider.TECHART.note": "Utvalgte modeller inkludert Claude, GPT, Gemini og mer",
  "dialog.provider.TECHART.tagline": "Pålitelige, optimaliserte modeller",
  "dialog.provider.TECHARTGo.tagline": "Rimelig abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av TECHART",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn din {{provider}} API-nøkkel for å koble til kontoen din og bruke {{provider}}-modeller i TECHART.",
  ...
  "provider.connect.TECHARTZen.line1":
    "TECHART Zen gir deg tilgang til et utvalg av pålitelige optimaliserte modeller for kodeagenter.",
  "provider.connect.TECHARTZen.line2":
    "Med én enkelt API-nøkkel får du tilgang til modeller som Claude, GPT, Gemini, GLM og flere.",
  "provider.connect.TECHARTZen.visit.prefix": "Besøk ",
  "provider.connect.TECHARTZen.visit.link": "TECHART.ai/zen",
  "provider.connect.TECHARTZen.visit.suffix": " for å hente API-nøkkelen din.",
  "provider.connect.oauth.code.visit.prefix": "Besøk ",
  "provider.connect.oauth.code.visit.link": "denne lenken",
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i TECHART.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i TECHART.",
  ...
  "dialog.plugins.empty": "Plugins konfigurert i TECHART.json",
  ...
  "dialog.server.description": "Bytt hvilken TECHART-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av TECHART ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til TECHART-teamet",
  ...
  "error.chain.checkConfig": "Sjekk leverandør-/modellnavnene i konfigurasjonen din (TECHART.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at TECHART ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "TECHART inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør TECHART-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for TECHART",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan TECHART ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description": "Velg om TECHART skal følge systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass hvordan TECHART er tematisert.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når TECHART starter",
  ...
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av TECHART.",
