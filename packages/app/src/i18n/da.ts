export const dict = {
  ...
  "dialog.provider.TECHART.note": "Udvalgte modeller inklusive Claude, GPT, Gemini og flere",
  "dialog.provider.TECHART.tagline": "Pålidelige optimerede modeller",
  "dialog.provider.TECHARTGo.tagline": "Billigt abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af TECHART",
  ...
  "provider.connect.apiKey.description":
    "Indtast din {{provider}} API-nøgle for at forbinde din konto og bruge {{provider}} modeller i TECHART.",
  ...
  "provider.connect.TECHARTZen.line1":
    "TECHART Zen giver dig adgang til et udvalg af pålidelige optimerede modeller til kodningsagenter.",
  "provider.connect.TECHARTZen.line2":
    "Med en enkelt API-nøgle får du adgang til modeller som Claude, GPT, Gemini, GLM og flere.",
  "provider.connect.TECHARTZen.visit.prefix": "Besøg ",
  "provider.connect.TECHARTZen.visit.link": "TECHART.ai/zen",
  "provider.connect.TECHARTZen.visit.suffix": " for at hente din API-nøgle.",
  "provider.connect.oauth.code.visit.prefix": "Besøg ",
  "provider.connect.oauth.code.visit.link": "dette link",
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode for at forbinde din konto og bruge {{provider}} modeller i TECHART.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge {{provider}} modeller i TECHART.",
  ...
  "dialog.plugins.empty": "Plugins konfigureret i TECHART.json",
  ...
  "dialog.server.description": "Skift hvilken TECHART-server denne app forbinder til.",
  ...
  "toast.update.description": "En ny version af TECHART ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til TECHART-teamet",
  ...
  "error.chain.checkConfig": "Tjek dine konfigurations (TECHART.json) udbyder/modelnavne",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, TECHART understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "TECHART inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.desktop.wsl.description": "Kør TECHART-serveren inde i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for TECHART",
  "settings.general.row.appearance.title": "Udseende",
  "settings.general.row.appearance.description": "Tilpas hvordan TECHART ser ud på din enhed",
  "settings.general.row.colorScheme.title": "Farveskema",
  "settings.general.row.colorScheme.description": "Vælg om TECHART følger systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas hvordan TECHART er temabestemt.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når TECHART starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af TECHART.",
